#!/bin/bash
#
# Justin's dotfile installer. Usage:
#
#   curl https://raw.github.com/jrnt30/dotfiles/master/install.sh | sh
#
# or:
#
#   ~/.dotfiles/install.sh
...
bindir=$HOME/bin
gitbase=git://github.com/jrnt30/dotfiles.git
tarball=http://github.com/jrnt30/dotfiles/tarball/master
